# list of street suffixes used later for cleaning addresses
street_suffix_list <-  c("Alley", "Allee", "Ally", "Aly",
                         "Annex", "Anex", "Annx", "Anx",
                         "Arcade", "Arc",
                         ...
                         "Strasse", #(the German word for street, used in Summit Park, Utah)
