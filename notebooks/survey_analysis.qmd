...
-   `svychisq()`: chisquared tests of association for survey data, computes first and second order Rao-Scott correction to the Peason chisquared test, can specify F stat (default), Chisq, Wald, adjWald, lincom, or saddlepoint
